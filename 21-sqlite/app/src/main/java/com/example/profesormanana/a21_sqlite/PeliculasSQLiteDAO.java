...
public class PeliculasSQLiteDAO extends SQLiteOpenHelper implements IPeliculasDAO {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        //Actualmente la version del software es 3, luego newVersion=3

        switch (oldVersion){
            case 1:
                //Ejecutamos el script para llevar el software a la version 2
            case 2:
                //Ejecutamos el script para llevar el software a la version 3
        }
    }
}
